        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['has given you a chocolate chip cookie!',
                    ...
                    'gives you a cookie imprinted with emojis. :electric_plug::a::poop: ',
           ...
           fortuneCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['gives you a fortune cookie. It reads, "extreme"',
                    'gives you a fortune cookie. It reads, "and then I said \'anime\'"',
                    'gives you a fortune cookie. It reads "i\'m different"',
                    'slaps you so hard you can\'t walk for a week. That\'s what you get.',
                    'gives you a fortune cookie. Oh wait. It\'s an origami. Bleck!',
                    'gives you a fortune cookie. It reads "wuw"',
                    'gives you a fortune cookie. It reads "Why aren\'t you working on any projects?"',
                    'gives you a fortune cookie. It reads "lets show me my moves"',
                    'gives you a fortune cookie. It reads "topkek"',
                    'gives you a fortune cookie. It reads "that is ice bear"',
                    ...
                    'gives you a Golden Fortune Cookie. You can\'t open it up to read because it is made of gold. Damnit.',
                    'gives you a fortune cookie. It reads "poodlel"',
                    'gives you a fortune cookie made with love. It reads ":heart:"',
                    'gives you a fortune cookie imprinted with emojis. They read ":electric_plug::a::poop:" ',
                    'bakes you a fresh fortune cookie. It so happens the paper is burnt. Damnit.'
                ],
                getCookie: function () {
                    var c = Math.floor(Math.random() * this.cookies.length);
                    return this.cookies[c];
            ...
            rollCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "http://i.imgur.com/SBAso1N.jpg";
                        API.sendChat(subChat('/me hahaha you thought you could roll huh well that\'s just too bad'));
                    }
                }
            },
