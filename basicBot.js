...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            welcome: true,
            opLink: null,
            rulesLink: "Don’t be a dick: no trolling, no spamming, no negative behavior, respect our staff and their decisions. ",
            themeLink: "All genres allowed, however, sometimes we will have a theme hour/night. If this is the case, it is always mentioned in the room name.",
            fbLink: "https://www.facebook.com/tagprogame",
            youtubeLink: null,
            website: "http://tagpro.gg/" ,
            intervalMessages: ["Hi, I am the bot for this room. I recommend getting PlugCubed: https://plugcubed.net/Install for autowoot, background and flairs.", "Someday I’ll take over the world. :) ", "\"I love Mussolnini\" - Mussolini", "I want to make bot babies.", "Tagpro is awsum.", "MostDeaths is the deaths co-most", "SaraAlba is zoubir.", "It's Sunna outside.", "zirconium pls", "Christmas songs are the worst - Ixion07", "Save our SOSFILMZ", "Bots need love too <3 ", "wutwubwutwubwutwub", "hai from dog", "Don’t be so Ruud", "Thank you for being here <3", "\"np I like being here\" – wut", "DostMeaths is our BnD expert.", "Salut La Jaquette!", "http://i.imgur.com/Hj5TUIC.png - Defender", "Laurens is the nicest guy ever." , "\"Today I didn’t saw a boobie\" – Selkie", "The best thing about Beyoncé is… everything – MothsDeast", "It’s Pantry Thyme!", "What does the FoxtrotDK say?", "If you like this room, please tell other TagPro players about it!", "Hola sukoley! <3 ", "ProDjMx is our EDM expert" , " :art: brxtr: http://i.imgur.com/tvejVtu.png"],
            messageInterval: 5,
            songstats: false,
            commandLiteral: "!",
            blacklists: {
